...
void main() => runApp(MaterialApp(home: (week32())));

class week32 extends StatefulWidget {
  @override
  State<week32> createState() => _week32State();
}

class _week32State extends State<week32> {
                        ...
                        Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Cheesy pasta with broccoli and avocado .",
                                style: GoogleFonts.poppins(
                                  textStyle: TextStyle(fontSize: 14),
                                ),
                              ),
