...
void main() => runApp(MaterialApp(home: (week27())));

class week27 extends StatefulWidget {
  @override
  State<week27> createState() => _week27State();
}

class _week27State extends State<week27> {
                        ...
                        Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                " 1  bowl of sweet shev cooked in milk .",
                                style: GoogleFonts.poppins(
                                  textStyle: TextStyle(fontSize: 14),
                                ),
                              ),
