...
void main() => runApp(MaterialApp(home: (week26())));

class week26 extends StatefulWidget {
  @override
  State<week26> createState() => _week26State();
}

class _week26State extends State<week26> {
                        ...
                        Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Veggie-rich sevai or upma (1 cup) +Oats meal.",
                                style: GoogleFonts.poppins(
                                  textStyle: TextStyle(fontSize: 14),
                                ),
                              ),
