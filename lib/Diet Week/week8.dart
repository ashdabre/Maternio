...
void main() => runApp(MaterialApp(home: (week8())));

class week8 extends StatelessWidget {
                        ...
                        Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "1 bowl of dahi + 2 medium-sized parathas.",
                                style: GoogleFonts.poppins(
                                  textStyle: TextStyle(fontSize: 14),
                                ),
                              ),
                        ...
                        Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "1 bowl of fish curry with 1 bowl of rice and green salad.",
                                style: GoogleFonts.poppins(
                                  textStyle: TextStyle(fontSize: 14),
                                ),
                              ),
