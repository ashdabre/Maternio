...
void main() => runApp(MaterialApp(home: (week35())));

class week35 extends StatefulWidget {
  @override
  State<week35> createState() => _week35State();
}

class _week35State extends State<week35> {
                        ...
                        Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Fruit saladMixed fruit salad made of mangoes, bananas, and berries of your choice (1 medium-sized plate).",
                                style: GoogleFonts.poppins(
                                  textStyle: TextStyle(fontSize: 14),
                                ),
                              ),
