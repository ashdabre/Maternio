...
void main() => runApp(MaterialApp(home: (week17())));

class week17 extends StatefulWidget {
  @override
  State<week17> createState() => _week17State();
}

class _week17State extends State<week17> {
