...
void main() => runApp(MaterialApp(home: (week33())));

class week33 extends StatefulWidget {
  @override
  State<week33> createState() => _week33State();
}

class _week33State extends State<week33> {
                        ...
                        Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Vegetable with 2 rotis and 1 bowl of rice.",
                                style: GoogleFonts.poppins(
                                  textStyle: TextStyle(fontSize: 14),
                                ),
                              ),
