...
class preg_diet extends StatefulWidget {
  @override
  State<preg_diet> createState() => _preg_dietState();
}

class _preg_dietState extends State<preg_diet> {
                            ...
                            children: [
                              ...
                              Flexible(
                                ...
                                children: [
                                  ...
                                  Text(
                                      "Blueberry shake (1 cup) and 1 Banana"),
                                ],
                              )),
                              SizedBox(width: 15),
                              IconButton(
